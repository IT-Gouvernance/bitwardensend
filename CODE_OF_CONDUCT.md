...
requests, discussions) of this project, and also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported by opening an issue, or, for sensitive reports, by contacting the
maintainers directly through [IT Gouvernance](https://www.it-gouvernance.fr/).
...
1. **Correction** — A private, written warning for an inappropriate or
   unwelcome use of language, with clarification on why the behavior was
   inappropriate.
